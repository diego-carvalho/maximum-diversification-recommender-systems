...
set xlabel "Usuários (%)" 
plot "acc.txt" using ((column(0) / 500) * 100):2 title "ItemKNN" with line lw 10 lc "#000000",\
...
set xlabel "Usuários (%)" 
plot "acc_Rel.txt" using ((column(0) / 500) * 100):3 title "ItemKNN" with line lw 10 lc "#000000",\

set output "div.eps"		#nome de saida
set ylabel "Diversidade" offset 1
set xlabel "Usuários (%)" 
plot "div.txt" using ((column(0) / 500) * 100):4 title "ItemKNN" with line lw 10 lc "#000000",\
